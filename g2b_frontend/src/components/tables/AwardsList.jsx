  ...
  return (
    <Paper sx={{ p: 3 }}>
      <Box
        ...
        mb={2}
      >
        <Typography variant="h5">낙찰정보 목록</Typography>
            ...
            {awards.map((award, index) => (
              <Box
                ...
                sx={{
                  ...
                  px: 2,
                  borderBottom:
                    index < awards.length - 1 ? "1px solid #eee" : "none",
                  cursor: "pointer",
                  "&:hover": {
                    bgcolor: "#f5f5f5",
                  },
              ...
              >
                ...
                >
                  ...
                  <Chip
                    ...
                    size="small"
                    color={
                      award.notice_type === "공사"
                        ? "error"
                        : award.notice_type === "용역"
                        ? "primary"
                        : "success"
                    }
                    sx={{ ml: 2 }}
                ...
                <Box display="flex" gap={3} flexWrap="wrap">
                  <Typography variant="body2" color="text.secondary">
                    공고번호: {award.bid_ntce_no || "-"}
                  </Typography>
                  <Typography variant="body2" color="primary" fontWeight="bold">
                    💰 {formatAmount(award.award_amount)}
                  </Typography>
                  <Typography variant="body2" color="success.main">
                    📊 낙찰률: {award.award_rate ? `${award.award_rate}%` : "-"}
                  </Typography>
                  <Typography variant="body2" color="text.secondary">
